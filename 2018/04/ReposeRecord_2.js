...
fs.readFile(filePath, {encoding: 'utf-8'}, function(err,data){
    if (!err) {
        ...
        Object.keys(guardSleepTimes).forEach(guardId => {
            const sleepAmoutByMinute = guardSleepTimes[guardId].reduce((prev, curr) => {
        ...
        console.log("Guard", sleepyGuard, "slept most in minute", maxMinute, "with an amout of", maxCount);
        console.log("Result =", sleepyGuard * maxMinute);
